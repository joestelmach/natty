// $ANTLR 3.2 Sep 23, 2009 14:05:07 com/joestelmach/natty/generated/TreeRewrite.g 2010-05-23 23:44:05
...
public class TreeRewrite extends TreeRewriter {
    ...
    // $ANTLR start "topdown"
    // com/joestelmach/natty/generated/TreeRewrite.g:12:1: topdown : ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_WEEK INT ) ^( DAY_OF_WEEK dow= INT ) ) -> ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_WEEK $dow) ) ;
    public final TreeRewrite.topdown_return topdown() throws RecognitionException {
        ...
        try {
            // com/joestelmach/natty/generated/TreeRewrite.g:13:3: ( ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_WEEK INT ) ^( DAY_OF_WEEK dow= INT ) ) -> ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_WEEK $dow) ) )
            // com/joestelmach/natty/generated/TreeRewrite.g:13:5: ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_WEEK INT ) ^( DAY_OF_WEEK dow= INT ) )
            {
            ...
            // AST REWRITE
            // elements: dow, SEEK_BY, SEEK, INT, DAY_OF_WEEK, DIRECTION
            // token labels: dow
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
            ...
            {
                // com/joestelmach/natty/generated/TreeRewrite.g:14:10: ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_WEEK $dow) )
                {
                ...
                // com/joestelmach/natty/generated/TreeRewrite.g:14:39: ^( DAY_OF_WEEK $dow)
                {
    ...
    public static final BitSet FOLLOW_DIRECTION_in_topdown56 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0002000000000000L});
    public static final BitSet FOLLOW_SEEK_BY_in_topdown58 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000004000000000L});
    public static final BitSet FOLLOW_INT_in_topdown60 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000020000000000L});
