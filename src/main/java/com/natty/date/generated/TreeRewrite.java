...
public class TreeRewrite extends TreeRewriter {
    ...
    public String getGrammarFileName() { return "com/natty/date/generated/TreeRewrite.g"; }
    ...
    // $ANTLR start "topdown"
    // com/natty/date/generated/TreeRewrite.g:12:1: topdown : ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_WEEK INT ) ^( DAY_OF_WEEK dow= INT ) ) -> ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_WEEK $dow) ) ;
    public final TreeRewrite.topdown_return topdown() throws RecognitionException {
        ...
        try {
            // com/natty/date/generated/TreeRewrite.g:13:3: ( ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_WEEK INT ) ^( DAY_OF_WEEK dow= INT ) ) -> ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_WEEK $dow) ) )
            // com/natty/date/generated/TreeRewrite.g:13:5: ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_WEEK INT ) ^( DAY_OF_WEEK dow= INT ) )
            {
            ...
            {
                // com/natty/date/generated/TreeRewrite.g:14:10: ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_WEEK $dow) )
                {
                ...
                // com/natty/date/generated/TreeRewrite.g:14:39: ^( DAY_OF_WEEK $dow)
                {
